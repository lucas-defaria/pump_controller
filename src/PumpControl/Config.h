...
namespace Config {
    ...
    // the input duty cycle as the target for the outputs (instead of MAP).
    // When signal is lost/idle, system falls back to MAP-based control.
    //
    ...
    constexpr bool  ENABLE_EXTERNAL_PWM_MODE = true;  // Allow external PWM at D8 to override MAP control
